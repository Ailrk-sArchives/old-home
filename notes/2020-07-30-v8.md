...
Some overview of support for js as a language. Frameworks like React and vue doesn't count as language support since they are stand alone project. Js ecosystem feels more decentralized than other languages, there is no one de facto source of tools.
...
## babel
Babel is not only a compiler between different verions of javascript today. As a layer between producing runtime code, a lot of compiler technics and code transformation can be done at this level.
